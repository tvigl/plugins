(function () {
  ...
  function startPlugin() {
      ...
      if (mobileMode === 'bottom') {
        ...
        rules.push('@media (max-width: 600px) {' +
          ...
          '  .lampac-mobile-poster-card {' +
            '    width: calc(100% - 2.2em) !important; margin: 0.45em 1.1em 0 !important;' +
            '    aspect-ratio: 2 / 3 !important; border-radius: 1em !important; overflow: hidden !important;' +
          ...
          '    content: ""; position: absolute; left: 0; right: 0; bottom: -2px; height: 40%; pointer-events: none;' +
          ...
          '    display: flex !important; flex-direction: column !important; justify-content: flex-end !important;' +
          '    row-gap: 0.35em !important; align-items: center !important; text-align: center !important;' +
          '    margin: 0 !important;' +
          '  }' +
          '  .full-start-new__right.lampac-mobile-right-on-poster {' +
            '    position: absolute !important; left: 0 !important; right: 0 !important; bottom: 0 !important;' +
            '    width: 100% !important; padding: 1.05em 0.95em 0.9em 0.95em !important;' +
            '    border-radius: 0 0 1em 1em !important;' +
          '    background: linear-gradient(to top, rgba(0,0,0,.88) 0%, rgba(0,0,0,.64) 52%, rgba(0,0,0,.26) 76%, rgba(0,0,0,0) 100%) !important;' +
          '    backdrop-filter: blur(10px) !important; -webkit-backdrop-filter: blur(10px) !important;' +
            '    z-index: 3 !important;' +
          '  }' +
          '  .full-start-new__right .full-start-new__logo { margin: 0 auto 0.3em auto !important; }' +
          '  .full-start-new__right .full-start-new__title { margin: 0 auto 0.3em auto !important; }' +
    ...
    function renderMobilePosterCard() {
      ...
      if (right.parentNode !== posterCard) posterCard.appendChild(right);
      right.classList.add('lampac-mobile-right-on-poster');
    ...
    function promoteFolderButtons(force) {
      ...
      if (!hideExtraButtons && trailerBtn) ordered.push(trailerBtn);
